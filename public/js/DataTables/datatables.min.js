 ...
 *   https://datatables.net/download/#bs4/jq-3.6.0/dt-1.12.1/af-2.4.0/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/date-1.1.2/fc-4.1.0/fh-3.2.4/r-2.3.0/sc-2.0.7/sl-1.4.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.12.1, AutoFill 2.4.0, Buttons 2.2.3, Column visibility 2.2.3, HTML5 export 2.2.3, Print view 2.2.3, DateTime 1.1.2, FixedColumns 4.1.0, FixedHeader 3.2.4, Responsive 2.3.0, Scroller 2.0.7, Select 1.4.0
 */
